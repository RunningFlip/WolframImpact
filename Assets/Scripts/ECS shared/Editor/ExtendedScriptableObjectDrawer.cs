...
/// </summary>
[CustomPropertyDrawer(typeof(EntityComponent), true)]
public class ExtendedScriptableObjectDrawer : PropertyDrawer
{
    ...
    public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
    {
        ...
        if (property.objectReferenceValue != null)
        {
            ...
            property.isExpanded = EditorGUI.Foldout(new Rect(position.x, position.y, EditorGUIUtility.labelWidth, EditorGUIUtility.singleLineHeight), property.isExpanded, data.GetType().ToString(), true, headerStyle);
            ...
            if (property.isExpanded)
            {
                ...
                GUI.Box(new Rect(position.x + 40, position.y + EditorGUIUtility.singleLineHeight + EditorGUIUtility.standardVerticalSpacing - 1, Screen.width, position.height - EditorGUIUtility.singleLineHeight - EditorGUIUtility.standardVerticalSpacing), "");
