...
public class ComponentManager
{
    ...
    private static Dictionary<int, EntityComponentPool> componentPoolTable = new Dictionary<int, EntityComponentPool>();
    ...
    /// <summary>
    /// Returns true if the component is already initialized.
    /// </summary>
    /// <typeparam name="T"></typeparam>
    /// <param name="_entityId"></param>
    /// <returns></returns>
    public static bool ComponentReady<T>(int _entityId) where T : EntityComponent
    {
        bool ready = false;

        T component = GetComponent<T>(_entityId);
