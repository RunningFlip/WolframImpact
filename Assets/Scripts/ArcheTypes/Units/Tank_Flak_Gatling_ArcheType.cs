...
[CreateAssetMenu(fileName = "Tank_Flak_Gatling_ArcheType", menuName = "ScriptableObjects/ArcheType Configs/Tank_Flak_Gatling_ArcheType")]
public class Tank_Flak_Gatling_ArcheType : SelectableArcheType
{
    [Header("Detection")]
